...
const texts = {
  ...
  mercatini: {
    ...
    vendors: [
      ...
      { name: "Luisa De Santi Art", cat: { it: "Artista", en: "Artist" }, desc: { it: "Artista tessile e mixed media, lavora con fili, carta, tessuti, plastica di riciclo sperimentando anche con fiori e piante locali.", en: "Textile and mixed-media artist working with threads, paper, fabrics and recycled plastic — also experimenting with local flowers and plants." }, instagram: "https://www.instagram.com/luisadesanti_art" },
      { name: "RobotBunny", cat: { it: "Abbigliamento", en: "Clothing" }, desc: { it: "Una vera collezionista con occhio attento al pezzo unico, con base a Trieste: porta i designer più interessanti e recupera i capi vintage più belli.", en: "A true collector with a sharp eye for unique pieces, based in Trieste, showcasing the coolest designers and rescuing the cutest vintage clothes." }, instagram: "https://www.instagram.com/robotbunnytrieste" },
      { name: "Patate in Techno", cat: { it: "Merchandising", en: "Merchandising" }, desc: { it: "Merchandising del brand che suona musica techno a Trieste.", en: "Merchandise from the brand that plays techno music in Trieste." }, instagram: "https://www.instagram.com/patateintechno" },
    ],
  },
  workshop: {
